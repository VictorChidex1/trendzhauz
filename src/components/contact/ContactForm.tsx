...
export function ContactForm({ subjectPreset, sourcePage }: ContactFormProps) {
  ...
  if (success) {
    return (
      <div className="bg-white dark:bg-zinc-900 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-8 shadow-xs text-center space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 font-medium leading-relaxed">
            Thanks for reaching out. The TrendzHauz team will get back to you
            shortly.
          </p>
        </div>
        <button
